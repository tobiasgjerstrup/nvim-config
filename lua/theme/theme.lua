...
theme.set_highlights = function(opts)
    ...
    hl(0, '@keyword.type', { fg = c.vscPink, bg = 'NONE' })
    hl(0, '@keyword.operator', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@operator', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@punctuation.bracket', { fg = c.vscYellow, bg = 'NONE' })
    hl(0, '@punctuation.delimiter', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@punctuation.special', { fg = c.vscYellow, bg = 'NONE' })
    hl(0, '@type', { fg = c.vscLightBlue, bg = 'NONE' })
    ...
    hl(0, 'typescriptAliasKeyword', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'typescriptClassName', { fg = c.vscLightBlue, bg = 'NONE' })
    ...
    hl(0, 'typescriptMember', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, 'typescriptTypeReference', { fg = c.vscLightBlue, bg = 'NONE' })
    ...
    hl(0, 'typescriptClassKeyword', { fg = c.vscPink, bg = 'NONE' })
    ...
    hl(0, 'typescriptEnumKeyword', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'typescriptEnum', { fg = c.vscLightBlue, bg = 'NONE' })
    ...
    hl(0, 'typescriptInterfaceKeyword', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'typescriptInterfaceExtends', { fg = c.vscPink, bg = 'NONE' })
    ...
    hl(0, 'BufferLineTab', { fg = c.vscFront, bg = c.vscTabOther })
    hl(0, 'BufferLineTabSelected', { fg = c.vscFront, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineCloseButton', { fg = c.vscGray, bg = bufferline_bg })
    hl(0, 'BufferLineCloseButtonVisible', { fg = c.vscGray, bg = c.vscTabOther })
    hl(0, 'BufferLineCloseButtonSelected', { fg = c.vscFront, bg = c.vscTabCurrent, bold = true })
    ...
    hl(0, 'BufferLineModifiedSelected', { fg = c.vscYellowOrange, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineIndicatorSelected', { fg = c.vscBlue, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineIndicatorVisible', { fg = c.vscBlue, bg = c.vscTabOther })
    ...
    hl(0, 'BufferLineSeparatorSelected', { fg = c.vscTabCurrent, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineTabSeparator', { fg = bufferline_bg, bg = bufferline_bg })
    hl(0, 'BufferLineTabSeparatorVisible', { fg = c.vscTabOther, bg = c.vscTabOther })
    hl(0, 'BufferLineTabSeparatorSelected', { fg = c.vscTabCurrent, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineDevIconDefault', { fg = c.vscGray, bg = bufferline_bg })
    hl(0, 'BufferLineDevIconDefaultInactive', { fg = c.vscGray, bg = c.vscTabOther })
    hl(0, 'BufferLineDevIconDefaultSelected', { fg = c.vscFront, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineNumbers', { fg = c.vscGray, bg = bufferline_bg })
    hl(0, 'BufferLineNumbersSelected', { fg = c.vscFront, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineNumbersVisible', { fg = c.vscGray, bg = c.vscTabOther })
    hl(0, 'BufferLineDuplicate', { fg = c.vscGray, bg = bufferline_bg })
    hl(0, 'BufferLineDuplicateSelected', { fg = c.vscGray, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineDuplicateVisible', { fg = c.vscGray, bg = c.vscTabOther })
    hl(0, 'BufferLinePick', { fg = c.vscGray, bg = bufferline_bg })
    hl(0, 'BufferLinePickSelected', { fg = c.vscGray, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLinePickVisible', { fg = c.vscGray, bg = c.vscTabOther })
    hl(0, 'BufferLineOffset', { fg = 'NONE', bg = bufferline_bg })
    hl(0, 'BufferLineGroupLabel', { fg = c.vscFront, bg = bufferline_bg })
    hl(0, 'BufferLineGroupSeparator', { fg = bufferline_bg, bg = bufferline_bg })
    hl(0, 'BufferLineTruncMarker', { fg = c.vscGray, bg = bufferline_bg })
    hl(0, 'BufferLineDiagnostic', { fg = c.vscGray, bg = bufferline_bg })
    hl(0, 'BufferLineDiagnosticSelected', { fg = c.vscGray, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineDiagnosticVisible', { fg = c.vscGray, bg = c.vscTabOther })
    hl(0, 'BufferLineError', { fg = c.vscRed, bg = bufferline_bg })
    hl(0, 'BufferLineErrorSelected', { fg = c.vscRed, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineErrorVisible', { fg = c.vscRed, bg = c.vscTabOther })
    hl(0, 'BufferLineErrorDiagnostic', { fg = c.vscRed, bg = bufferline_bg })
    hl(0, 'BufferLineErrorDiagnosticSelected', { fg = c.vscRed, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineErrorDiagnosticVisible', { fg = c.vscRed, bg = c.vscTabOther })
    hl(0, 'BufferLineWarning', { fg = c.vscYellowOrange, bg = bufferline_bg })
    hl(0, 'BufferLineWarningSelected', { fg = c.vscYellowOrange, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineWarningVisible', { fg = c.vscYellowOrange, bg = c.vscTabOther })
    hl(0, 'BufferLineWarningDiagnostic', { fg = c.vscYellowOrange, bg = bufferline_bg })
    hl(0, 'BufferLineWarningDiagnosticSelected', { fg = c.vscYellowOrange, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineWarningDiagnosticVisible', { fg = c.vscYellowOrange, bg = c.vscTabOther })
    hl(0, 'BufferLineInfo', { fg = c.vscBlue, bg = bufferline_bg })
    hl(0, 'BufferLineInfoSelected', { fg = c.vscBlue, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineInfoVisible', { fg = c.vscBlue, bg = c.vscTabOther })
    hl(0, 'BufferLineInfoDiagnostic', { fg = c.vscBlue, bg = bufferline_bg })
    hl(0, 'BufferLineInfoDiagnosticSelected', { fg = c.vscBlue, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineInfoDiagnosticVisible', { fg = c.vscBlue, bg = c.vscTabOther })
    hl(0, 'BufferLineHint', { fg = c.vscGray, bg = bufferline_bg })
    hl(0, 'BufferLineHintSelected', { fg = c.vscGray, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineHintVisible', { fg = c.vscGray, bg = c.vscTabOther })
    hl(0, 'BufferLineHintDiagnostic', { fg = c.vscGray, bg = bufferline_bg })
    hl(0, 'BufferLineHintDiagnosticSelected', { fg = c.vscGray, bg = c.vscTabCurrent, bold = true })
    hl(0, 'BufferLineHintDiagnosticVisible', { fg = c.vscGray, bg = c.vscTabOther })
